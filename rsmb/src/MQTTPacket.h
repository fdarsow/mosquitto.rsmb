...
typedef struct
{
	...
	char *username;			/**< 3.1 username value */
	char *password;			/**< 3.1 password value */
} Connect;
...
int MQTTPacket_send_suback(int aRc, int noOfTopics, int* qoss, int socket, char* clientID);
...
int MQTTPacket_send_unsuback(int aRc, int socket, char* clientID);
